...
<ul>
  ...
  <ul>
    <li><b><a href="[https://cloud.google.com/translate/docs/reference/rest/](https://github.com/safnana/Explore-Indonesia/blob/main/README.md#backend-and-cloud-architecture)">Cloud Architecture</a></b></li>
